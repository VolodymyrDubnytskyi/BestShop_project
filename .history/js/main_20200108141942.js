    ...
    const eventForQuantity = function (e) {
        ...
        if (quantity.value === '' || quantity.value === null || quantity.value === undefined || quantity.value <= 0) {
            ...
            if (iteamFromStorage.quantity.length >= 2){
                let totalInnerText2 = iteamFromStorage.quantity[iteamFromStorage.quantity.length - 1];
                let totalInnerText = sum - iteamFromStorage.quantity[iteamFromStorage.quantity.length - 1];
