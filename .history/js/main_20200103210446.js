document.addEventListener('DOMContentLoaded', function () {
    ...
    select.addEventListener('click', function () {
        if (select.className === 'selcet-package selcet-package-activ-arrow') {
            ...
            let span1 = document.createElement('span').classList.add('span-select').innerText = 'Basic';
            let span2 = document.createElement('span').classList.add('span-select').innerText = 'Professional';
            let span3 = document.createElement('span').classList.add('span-select').innerText = 'Premium';
