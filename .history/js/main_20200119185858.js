            ...
            for (const el of spanClick) {
                el.addEventListener('click', function (e) {
                    ...
                    if (select.value === "professional") {
                        ...
                        countFn(parseFloat(productsSum.innerText), parseFloat(ordersSum.innerText), parseFloat(selectPackageSum.innerText), parseFloat(accountingSum.innerText), parseFloat(terminalSum.innerText), parseFloat(count.innerText));
