    ...
    for (const el of containerChekbox) {
        el.addEventListener('change', function () {
            if (checkboxAccounting.checked) {
                ...
                if(sessionStorage.getItem('accountingAgree') === null || sessionStorage.getItem('accountingAgree')   undefined)
                console.log('do not checked');
                valueAccounting.style.display = 'none';
            ...
            } else if (!checkboxRental.checked) {
                if (sessionStorage.getItem('chekboxChecked') === undefined || sessionStorage.getItem('chekboxChecked') === null) {
                    console.log('dziala');
                } else {
