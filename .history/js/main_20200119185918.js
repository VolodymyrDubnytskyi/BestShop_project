                ...
                el.addEventListener('click', function (e) {
                    ...
                    if (select.value === "professional") {
                        ...
                        function countFn (par1=0, par2=0, par3=0, par4=0, par5=0){
                         ...
                         cosnt sum222 = countFn(parseFloat(productsSum.innerText), parseFloat(ordersSum.innerText), parseFloat(selectPackageSum.innerText), parseFloat(accountingSum.innerText), parseFloat(terminalSum.innerText), parseFloat(count.innerText));
